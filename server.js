...
app.get('/status-info', (req, res) => {
  const statusCodes = req.query.code;
  let message = "";
  switch(statusCodes) {
    case '200':
      message = "OK: The request has succeeded. The meaning of this status depends on the HTTP method used.";
    ...
    case '502':
      ...
      break;
    case '503':
      message = "Service Unavailable: The server is currently unable to handle the request due to a temporary overload or maintenance of the server.";
      break;
    case '504':
